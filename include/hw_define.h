...
#define GPIO_INPUT_PIN_SELECT ((1ULL<<GPIO_IMD)|(1ULL<<GPIO_BSPD)|(1ULL<<GPIO_LATCH)|(1ULL<<GPIO_AIRN)|(1ULL<<GPIO_AIRP)|(1ULL<<GPIO_CHARGE_EN))
...
#define GPIO_OUTPUT_PIN_SELECT ((1ULL<<GPIO_BMS_OK)|(1ULL<<GPIO_PRECH_OK)|(1ULL<<GPIO_RED_LED)|(1ULL<<GPIO_GREEN_LED))
